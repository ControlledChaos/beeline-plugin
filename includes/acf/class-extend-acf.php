...
class Extend_ACF {
	...
	public function admin_styles() {
		...
		wp_enqueue_style( BLP_ADMIN_SLUG . '-acf-admin', BLP_URL . 'includes/acf/assets/css/admin.min.css', [], BLP_VERSION, 'screen' );
	...
	public function admin_scripts() {
		...
		wp_enqueue_script( BLP_ADMIN_SLUG . '-acf-admin', BLP_URL . 'includes/acf/assets/js/admin.min.js', [ 'jquery' ], BLP_VERSION, true );
