...
$title       = apply_filters( 'blp_admin_header_title', $title );
$description = apply_filters( 'blp_admin_header_description', $description );
$menu        = apply_filters( 'blp_admin_header_menu', $menu );
?>
...
<header class="blp-admin-header">
    ...
    <?php do_action( 'blp_after_admin_site_branding' ); ?>
    <?php do_action( 'blp_before_admin_navigation' ); ?>
    ...
    <?php do_action( 'blp_after_admin_navigation' ); ?>
</header>
